...
char fen80[] = "rnbqkbnr/8/8/8/8/8/8/RNBQKBNR";
...
char* fen90 = "rnbqkqbnr/ppppppppp/9/r8/9/R7r/9/PPPPPPPPP/RNBQKQBNR";
char* pgn90[] = {
    "Rxi4", "Ra4",
    "Rxi8", "Ri4",
    "Rxi9", "Rxi9",
...
void main() {
    char* fens[] = { fen80,fen81, fen82, fen83, fen84, fen85, fen86, fen87, fen88, fen89, fen90 };
    char** pgns[] = { pgn80,pgn81, pgn82, pgn83, pgn84, pgn85, pgn86, pgn87, pgn88, pgn89, pgn90 };
    int sizes[] = { sizeof(pgn80),sizeof(pgn81),sizeof(pgn82),sizeof(pgn83),sizeof(pgn84),sizeof(pgn85),sizeof(pgn86),sizeof(pgn87),sizeof(pgn88),sizeof(pgn89),sizeof(pgn90) };
    int i;
